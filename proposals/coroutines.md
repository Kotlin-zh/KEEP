...
* *协程*——*可挂起计算*的*实例*。它在概念上类似于线程，在这个意义上，<!--
  -->它需要一个代码块运行，并具有类似的生命周期 —— 它可以被*创建*与*启动*，但它不绑定到<!--
...
如上所述，驱动协程的要求之一是灵活性：<!--
-->我们希望能够支持许多现有的异步 API 以及其他用例，并尽量减少<!--
...
-->像调用 `suspendCoroutine` 那样调用其他挂起函数。编译这种挂起函数就与编译普通的非挂起函数一样，<!--
