...
-->*挂起函数* 隐式地接受<!--
-->*续体*（[续体](https://aisia.moe/2018/02/08/kotlin-coroutine-kepa/)就是一般的回调）。
...
还有另一种表达异步计算的方式：通过 future（或者叫做 promise 或 deferred）。<!--
-->我们将在在示例中使用一个虚构的应用程序接口，对图像应用一个覆盖：
...
> 关于 `future{}` 的示例代码在[创建 Future](#创建-Future) 一节，<!--
